...
You can find the url for your portal in URL field of the portal record. You can use server configuration tools (such mod_rewrite) to be able to access by different url.
