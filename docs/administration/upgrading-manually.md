...
!!! note
    ...
    This article covers non-containerized setups. For upgrading EspoCRM running with Docker, see the instructions [here](docker/installation.md#upgrading).
...
1. Open the file `data/state.php`.
