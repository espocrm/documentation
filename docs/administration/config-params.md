...
Config parameters can be changed or added manually in the file `data/config.php`. As of v7.0.0 parameters can be added to the file `data/config-internal.php`. Use the internal config to store sensitive parameters.
