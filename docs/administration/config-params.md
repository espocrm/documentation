...
* jobNoTableLocking – false – don't use table locking; can be useful for database clusters where tablelocking is not allowed; jobRunInParallel must be enabled if this parameter is set to true (as of v7.5);
