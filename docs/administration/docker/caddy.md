...
Caddy is an open-source HTTP/2-enabled web server written in Go. It can automatically manage TLS certificates, simplifying deployment of web applications.
