...
Before performing the following steps, be sure to make a [Backup](#docker-installation). By following these instructions, your customizations and data will be preserved.
