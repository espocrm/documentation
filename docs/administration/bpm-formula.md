...
Returns the code of a caught error. Error codes are of the string type. Can be used in after catching Error Events.
...
Returns the message of a caught exception. Can be used in after catching Error Events.
