...
MardiaDB has made optimizer improvements that make some sub-queries running much faster than in MySQL. As of Espo v7.4, filters by teams, relations, multi-enums performs better on MariaDB.
