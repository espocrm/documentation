...
!!! note
    ...
    To be able to access the repository by an entity class, your [custom entity](custom-entity-type.md#entity-class) class must have a public `ENTITY_TYPE` constant.
