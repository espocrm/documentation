...
The *Espo.Ajax* object is used to make requests to Espo API endpoints. See the [source file](https://github.com/espocrm/espocrm/blob/master/client/src/ajax.ts) with JSDoc for more info. An API base path `api/v1` is prepended to each request URL. 
