...
In some cases it is reasonable to execute an action in background. For example, to send an email while preventing the user to wait until the sending is processed. 
