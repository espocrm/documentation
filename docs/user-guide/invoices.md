...
List prices for invoices are disabled by default. You can enable them at Administration > Sales Pack Settings > List Prices in Invoices, then add the *List Price* field to the Invoice Items layout.
