...
If some charecters are not displayed in generated PDF files, it usually can be solved by changing a font in a template. For Arabic language use 'AlArabiya' font. For Central European languages try 'DejaVu' fonts. Available since 5.4.0 version. 
